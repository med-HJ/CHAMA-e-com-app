    ...
    <div class="row f-flex justify-content-around">
        ...
        <div class="col-12 col-lg-5 mt-5">
          ...
          {Array(3)
            ...
            <span style={{ marginLeft: '.5rem' }} >{5}</span>
            ...
            <p id="product_price">10080.00 DH</p>
            <div class="stockCounter d-inline">
             ...
             <button type="button" id="cart_btn" class=" dd btn btn-primary d-inline ml-4">Add to Cart</button>
            ...
            <hr />
            <p id="product_seller mb-3">Sold by: <strong>CHAMA</strong></p>
